...
function loginCheck(){
	...
	document.loginForm.action = '/login/loginCheck';
...
<body>
	...
	%>
		...
		<div class="row">
			...
			<div id="msg_id" class="msg"> 존재하지 않는 아이디입니다.</div>
			</c:if>
		</div>
		<div class="row">
		...
		<div class="btn_box">
		<div class="btn_row">
			<INPUT TYPE="button" class="button" id="btn_login" NAME="Submit" VALUE="로그인하기" onclick="loginCheck()">
		</div>
		<div class="btn_row">
			<INPUT TYPE="button" class="button" id="btn_join" VALUE="회원 가입하기" onClick="location.href='/login/join'">
		</div>
		</div>
