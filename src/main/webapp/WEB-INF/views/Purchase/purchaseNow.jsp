...
<body>
	...
	<div class="detailForm">
			...
			<div class="orderComponentCard">
				...
				<div class="priceInfo"> 1 개 / ${strPrice} 원 </div>
			...
			<div class="totalPrice">상품전체금액  ${strPrice} 원</div>
			</div>
		</div>		
	</div>
	...
	<div class="detailForm">
			...
			<div class="orderInfoCard" id="orderPersonInfo">
					...
					<input type="text" class="field" value=" ${member.username}" disabled>
					</div>
					<div class="cardRow">
					<label class="rowTitle">전화번호</label>
					<input type="text" class="field" value="${member.telno}" disabled>
					</div>
					<div class="cardRow">
					<label class="rowTitle">이메일</label>
					<input type="text" class="field" value="${member.email}" disabled>
					</div>
			</div>
		</div>		
	</div>
	...
	<div class="detailForm">
		...
		<div class="radio_btn">
				...
				<div class="cardRow">
				<label class="rowTitle">이름</label>
				<input type="text" class="field" id="name" name="name" maxlength="50" value="${member.username}" autoComplete="off">
				<div id="msg_name" class="msg">이름을 입력해주세요.</div>
				</div>
				<div class="cardRow">
				<label class="rowTitle">우편번호</label>
				<input type="text" class="field" id="postcode" name="postcode" placeholder="우편번호" value="${member.postcode}" disabled>
				<input type="button" id="btn_address" onclick="execDaumPostcode()" value="우편번호 찾기">
				</div>
				<div class="cardRow">
				<label class="rowTitle">주소</label>
				<input type="text" class="field" id="address" name="address" placeholder="기본주소" value="${member.address}" disabled><br>
				<input type="text" class="field" id="detailAddress" name="detailAddress" value="${member.detailAddress}" placeholder="상세주소" autoComplete="off">
				<input type="hidden" class="field" id="extraAddress" name="extraAddress" value="${member.extraAddress}" disabled>
				<div id="msg_address" class="msg">주소지를 입력해주세요.</div>
				</div>
				<div class="cardRow">
				<label class="rowTitle">전화번호</label>
				<input type="text" class="field" id="telno" name="telno" maxlength="13" value="${member.telno}"  autoComplete="off"  />
		...
		<input type="button" id="btn_purchase" class="button" value=" ${strPrice}원 결제하기">
		<input type="hidden" name = "totalPrice"  value="${product.p_unitPrice}">
